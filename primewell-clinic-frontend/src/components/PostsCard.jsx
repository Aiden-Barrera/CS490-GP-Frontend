        ...
        <Flex gap="50px" justify="flex-start" align="flex-start">
          ...
          <Flex vertical gap="10px" style={{ maxWidth: "400px", flex: 1 }}>
            ...
            <Flex justify="space-between" align="center">
              ...
              <Text>
                {postInfo?.Sets} Sets @ {postInfo?.Reps} Reps
              </Text>
            </Flex>
            <Flex vertical style={{ marginTop: "8px" }}>
              <Text type="secondary">Description:</Text>
              <Paragraph style={{ marginBottom: 0 }}>
                {postInfo?.Exercise_Description}
              </Paragraph>
            </Flex>
          </Flex>
          ...
          <Flex vertical gap="10px" style={{ maxWidth: "500px", flex: 1 }}>
            <Title level={4} style={{ marginBottom: "4px" }}>
              {`${userInfo?.First_Name} ${userInfo?.Last_Name}`}'s Feedback
            </Title>
        ...
        <Flex gap="50px" justify="flex-start" align="flex-start">
          ...
          <Flex vertical gap="10px" style={{ maxWidth: "500px", flex: 1 }}>
            ...
            <AddCommentModal
              ...
              Forum_ID={postInfo.Forum_ID} /*onPostCreated={handleNewPost}*/
            />
          </Flex>
        </Flex>
        <Flex gap="50px" justify="flex-start" align="flex-start">
