  ...
  return (
    ...
    >
      ...
      >
        ...
        <Button id="start-appt" type="primary" style={{fontWeight: "700", fontSize: "18px", backgroundColor: "#ffe6e2", color: "#333333", padding: "20px", boxShadow: "0 4px 10px rgba(0, 0, 0, 0.2)"}} onClick={handleClick}>
            Start Appointment
        </Button>
      </Content>
    </Layout>
